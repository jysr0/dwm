...
static const char *fonts[]          = { "LiterationMonoNerdFontMono:size=10" };
static const char dmenufont[]       = "LiterationMonoNerdFontMono:size=10";
...
static const char *filemancmd[]  = { "bash -c 'lf ~'", NULL };
...
static const Key keys[] = {
	...
	/* brightness control */	
 	...
 	/* audio control */	
   	...
   	{ MODKEY,                       XK_s,       spawn,         { .v = browsercmd } }, /* default browser */	
   	{ MODKEY,                       XK_e,       spawn,         { .v = filemancmd } }, /* default file manager */	
